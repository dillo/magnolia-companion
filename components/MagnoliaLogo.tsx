...
export default function MagnoliaLogo() {
  return (
    <Link
      ...
      className="group flex min-w-0 items-center justify-start gap-2 text-left sm:gap-3"
    >
      ...
      <span className="whitespace-nowrap font-display text-[1.05rem] font-semibold leading-tight group-hover:text-copper sm:text-[1.35rem]">
        Magnolia Companion
      </span>
    </Link>
  );
